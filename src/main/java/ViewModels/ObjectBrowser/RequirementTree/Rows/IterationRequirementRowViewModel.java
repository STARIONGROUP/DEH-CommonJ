/*
 * IterationRequirementRowViewModel.java
 *
 ...
 */
public final class IterationRequirementRowViewModel extends IterationRowViewModel<RequirementSpecificationRowViewModel>
{
    /**
     * Initializes a new {@linkplain IterationRequirementRowViewModel}
     * 
     * @param iteration the represented {@linkplain Iteration}
     */
    public IterationRequirementRowViewModel(Iteration iteration)
    {
        super(iteration);
    ...
    public void ComputeContainedRows()
    {
        ...
        this.GetThing().getRequirementsSpecification()
            .stream()
            .forEach(x -> this.containedRows.add(new RequirementSpecificationRowViewModel(x)));
    }    
}