...
We would like to start with saying thank you for wanting to contribute to DEH-CommonJ codebase. We want to keep it as easy as possible to contribute changes that get things working in your environment. There are a few guidelines that we need contributors to follow so that we have a chance of keeping on top of things.
...
1. Configure the upstream repo (`git remote add upstream git://github.com/STARIONGROUP/DEH-CommonJ`)
...
While you're working away in your branch it's quite possible that your upstream development (most likely the canonical DEH-CommonJ version) may be updated. If this happens you should:
...
And remember; **A pull-request with tests is a pull-request that's likely to be pulled in.** :grin: Bonus points if you document your feature in our [wiki](https://github.com/STARIONGROUP/DEH-CommonJ/wiki) once it has been pulled in
